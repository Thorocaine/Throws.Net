...
namespace TestHelper
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        static readonly MetadataReference CorlibReference =
            CreateReferenceFromFile(typeof(object).Assembly.Location);

        static readonly MetadataReference SystemCoreReference =
            CreateReferenceFromFile(typeof(Enumerable).Assembly.Location);

        static readonly MetadataReference CSharpSymbolsReference =
            CreateReferenceFromFile(typeof(CSharpCompilation).Assembly.Location);

        static readonly MetadataReference CodeAnalysisReference =
            CreateReferenceFromFile(typeof(Compilation).Assembly.Location);
        ...
        static MetadataReference CreateReferenceFromFile(string location)
        ...
        static Diagnostic[] GetSortedDiagnostics(
            string[] sources,
            string language,
